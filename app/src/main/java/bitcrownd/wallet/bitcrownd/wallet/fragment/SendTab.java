...
import bitcrownd.wallet.bitcrownd.model.APIException;
import bitcrownd.wallet.bitcrownd.model.AssetDefinition;
import bitcrownd.wallet.bitcrownd.model.WalletState;
import bitcrownd.wallet.bitcrownd.utils.Formatting;
import bitcrownd.wallet.bitcrownd.wallet.ProgressDialog;
import bitcrownd.wallet.bitcrownd.wallet.UserPreferences;
import bitcrownd.wallet.bitcrownd.wallet.adapter.AssetSelectorAdapter;
...
public class SendTab extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Button scanButton = (Button)rootView.findViewById(R.id.qrCodeButton);
        ...
        Button button1 = (Button) getView().findViewById(R.id.btcexchange);
        button1.setOnClickListener(new View.OnClickListener() {
        @Override
           public void onClick(View view) {
                 Intent Intent = new Intent(view.getContext(), bitcrownd.wallet.bitcrownd.exchange.MainActivity.class);
